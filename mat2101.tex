...
Equations}\\
        Class Techer: Md. Motaleb Hossen\\
    \end{Large}
    \vspace{0.5cm}
    \begin{center}
        {\Large\textbf{ Note by}} \\
...
\begin{tcolorbox}[breakable, title = {\textbf{Example : }}]
    Example: The general solution of \( \frac{dy}{dx} = x \) is 
$
y = \frac{x^2}{2} + C
$
\\ And 
...
%Here, $\( y = 0 \)$  is a singular solution of the differential equation $\left( \frac{dy}{dx} \right)^2 - 4y = 0$
...
\vspace{1em}
\begin{tcolorbox}[breakable, title = {\textbf{Example : }Find the D.E of the relation $y = Ae^{2x} + Be^{-2x} $, where A, B are constants.}]
    \textbf{Solution : }
\[
y = Ae^{2x} + Be^{-2x}
...
\end{tcolorbox}
 ...
 \begin{tcolorbox}[breakable, title = {\textbf{Example : }Find the DE of the relation \( y = (c + x)^2 \)}]
    \textbf{Solution : }
