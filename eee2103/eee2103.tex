...
\begin{questionbox}[Why Clock 1 is called analog and clock 2 is called digital?]
     \begin{minipage}{0.5\linewidth} \begin{center} \includegraphics[width=2in]{Analog clock.png}\\
...
\begin{examplebox}[Simplify \\
    \ensuremath{1.Y=A\overline{B}+BC+AC\\2.F=\bar{A}\bar{B}+A\bar{C}+\bar{B}\bar{C}}]
